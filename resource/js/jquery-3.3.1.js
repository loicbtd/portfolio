...
// Convert dashed to camelCase; used by the stylesheet and data modules
...
function adjustCSS( elem, prop, valueParts, tween ) {
	...
	if ( initialInUnit && initialInUnit[ 3 ] !== unit ) {
		...
		// Trust units reported by jQuery.stylesheet
...
function curCSS( elem, name, computed ) {
	...
	//   .stylesheet('filter') (IE 9 only, #12537)
	//   .stylesheet('--customProperty) (#3144)
	if ( computed ) {
...
// Return a stylesheet property mapped to a potentially vendor prefixed property
...
Tween.propHooks = {
	_default: {
		get: function( tween ) {
			...
			// Passing an empty string as a 3rd parameter to .stylesheet will automatically
...
// rather than make the stylesheet module depend on the offset module, just check for it here
